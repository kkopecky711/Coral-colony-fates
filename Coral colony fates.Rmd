...
```{r}
area.2017 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2018.csv") %>%
  clean_names() %>% 
  rename(size = area1) %>%
  group_by(class) %>% 
...
area.2018 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2018.csv") %>%
  clean_names() %>% 
  rename(size = area2) %>% 
  group_by(class) %>% 
  summarize(area = sum(size)*0.0001) %>% 
...
area.2019 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2019.csv") %>%
  clean_names() %>%
  rename(size = area2) %>% 
  group_by(class) %>% 
  summarize(area = sum(size)*0.0001) %>% 
...
area.2020 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2020.csv") %>% 
  clean_names() %>% 
  rename(size = area2) %>% 
  group_by(class) %>% 
  summarize(area = sum(size)*0.0001) %>% 
...
live_dead.area <- live_dead.area %>% 
  mutate(coral_condition = case_when(class == "Pocillopora_dead" ~ "Dead",
                                TRUE ~ "Live")) %>% 
...
sizes.2017 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2018.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(class == "Pocillopora",
         action != "born",
         area1 > 20,
...
sizes.2018 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2018.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(class == "Pocillopora",
         action != "born",
         area2 > 20,
...
sizes.2019 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2019.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(class == "Pocillopora",
         action != "born",
         area2 > 20,
...
sizes.2020 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2020.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
...
dead_sizes.2017 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2018.csv") %>%
  clean_names() %>% 
  select(-area2) %>% 
...
dead_sizes.2018 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2018.csv") %>%
  clean_names() %>% 
  filter(class == "Pocillopora",
         area1 > 20,
         action == "dead",
...
dead_sizes.2019 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2019.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(class == "Pocillopora",
         action == "dead",
         area1 > 20,
...
dead_sizes.2020 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2020.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(class == "Pocillopora",
         action == "dead",
         area1 > 20,
...
# 2017
plot18_sankey.2017 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2020_even more updated.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(period == "2017-2018",
         class == "Pocillopora",
         area1 > 20,
...
# 2018
plot18_sankey.2018 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2020_even more updated.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(period == "2017-2018",
         class == "Pocillopora",
         action != "born",
...
# 2019
plot18_sankey.2019 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2020_even more updated.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(period == "2019-2020",
         class == "Pocillopora",
         action != "born",
...
# 2020
plot18_sankey.2020 <- read_csv("Data/Plot 18/Plot18_even more updated/Plot18_2017-2020_even more updated.csv") %>% #read.csv("Data/Plot 18/Matches/Plot18_2017-2020_matches.csv") %>% 
  clean_names() %>% 
  filter(period == "2019-2020",
         #class == "Pocillopora",
         action != "born",
